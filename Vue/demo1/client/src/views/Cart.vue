        ...
        <div class="cart-foot-wrap">
          <div class="cart-foot-inner">
            ...
            <div class="cart-foot-r">
              ...
              <div class="btn-wrap">
                <a class="btn btn--red" @click="checkOut">Square</a>
              </div>
            </div>
          </div>
        </div>
...
<script>
  ...
  export default {
    ...
    computed:{
      ...
      checkedCount(){
        var i = 0
        var cartList = Array.from(this.cartList)
    ...
    methods: {
      //获取商品列表
      getCartList() {
        this.$http.post('/api/users/cartList').then((result) => {
      ...
      //业务逻辑
      //1.当前购物车里面的所有商品数量 ==  被选中的数量一致  --> 所有的都被选中，如果是这个状态，此时点击按钮，全反选，否则取反
      //2.
      togglecheckAll(){
        //1.判断此时是否被全选或全反选
